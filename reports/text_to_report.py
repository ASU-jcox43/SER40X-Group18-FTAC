...
def generate_report_from_txt(txt_path: str, output_docx: str, prompt: str):
    """
    Reads a txt file, sends it with a prompt to the ChatGPT API,
...
def process_folder(input_folder: str, output_folder: str, prompt: str):
    ...
    for filename in os.listdir(input_folder):
        if filename.lower().endswith(".txt"):
            ...
            generate_report_from_txt(txt_path, output_path, prompt)
